...
const TopChartCard = ({ song, i, handlePlayClick, handlePauseClick, activeSong, isPlaying }) => (
  <div className="w-full flex flex-row items-center hover:bg-[#766A2A] py-2 p-4 cursor-pointer rounded-lg mb-2">
